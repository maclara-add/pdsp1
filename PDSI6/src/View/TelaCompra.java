...
public class TelaCompra extends JFrame {
    ...
    public TelaCompra() {
        ...
        btnAdicionar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) { adicionarAoCarrinho(); }
        });
        ...
        btnRemover.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) { removerDoCarrinho(); }
        });
        ...
        btnNotaFiscal.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) { emitirNotaFiscal(); }
        });
    ...
    private void carregarProdutosNaTabela() {
        ...
        if (lista != null && !lista.isEmpty()) {
            for (Produtos p : lista) {
                modeloProdutos.addRow(new Object[] { p.getNome(), p.getPreco(), p.getCategoria(), p.getId(), p.getEstoque() });
            }
        }
    }
    ...
    private void adicionarAoCarrinho() {
        ...
        if (linhaSelecionada >= 0) {
            ...
            String precoStr = modeloProdutos.getValueAt(linhaSelecionada, 1).toString();
            ...
            } catch (NumberFormatException ex) { JOptionPane.showMessageDialog(this, "Digite um número válido."); return; }

            if (qtdDesejada > estoque) { JOptionPane.showMessageDialog(this, "Estoque insuficiente! Estoque atual: " + estoque); return; }

            Produtos produto = ListaProdutos.buscarPorId(id);
            if (produto != null) produto.setEstoque(produto.getEstoque() - qtdDesejada);

            carregarProdutosNaTabela();

            double subtotal = Double.parseDouble(precoStr) * qtdDesejada;
            modeloCarrinho.addRow(new Object[]{nome, precoStr, qtdDesejada, subtotal, id});
            carrinho.adicionarProduto(new Produtos(nome, precoStr, "", id, qtdDesejada));
    ...
    private void removerDoCarrinho() {
        ...
        if (linhaSelecionada >= 0) {
            ...
            Produtos p = ListaProdutos.buscarPorId(id);
            if (p != null) p.setEstoque(p.getEstoque() + qtd);
